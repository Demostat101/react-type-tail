...
const Love = ({close, open}:Props) => {
  ...
  return (
    <div className="bg-yellow-200 w-80 p-3 transition fixed z-10">
      <button className="w-full h-10 cursor-pointer bg-pink-400 text-white outline-none font-bold" onClick={()=> close(!open)}>Close Modal</button>
      <div>
